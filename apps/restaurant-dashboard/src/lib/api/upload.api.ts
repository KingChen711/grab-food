...
export const uploadApi = {
  ...
  /**
   * Claim deletes the tracking DB row and returns CDN URLs.
   * Call this only after the URL has been durably saved to an entity.
   */
  ...
  /**
   * Uploads a file end-to-end: presign → PUT to MinIO → confirm → wait for processing.
   * Returns CDN URL + uploadId WITHOUT claiming. Caller must call claim() after saving.
   */
  uploadFile: async (
    file: File,
    context: UploadContext,
